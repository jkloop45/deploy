...
docker pull registry.cn-hangzhou.aliyuncs.com/sharkseven/gospel-debug-nodejs4.4.4:latest
...
docker tag registry.cn-hangzhou.aliyuncs.com/sharkseven/gospel-debug-nodejs4.4.4:latest gospel-debug-nodejs:4.4.4
